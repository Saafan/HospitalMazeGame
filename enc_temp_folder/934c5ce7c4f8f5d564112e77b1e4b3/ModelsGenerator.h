...
light0.SetDirection(0.027, -0.081, 0.006);
lights.push_back(light0);

LightModel light1(1, 20);
light1.lightIndex =16385;
light1.SetPosition(0.406, 1.696, 0.209);
light1.SetAmbient(0.1, 0.1, 0.1);
light1.SetDiffuse(1, 1, 0.972549);
light1.SetDirection(1.186, -1.136, 0.209);
...
light4.SetPosition(-0.409, 2.883, 0.498);
light4.SetAmbient(0.1, 0.1, 0.1);
light4.SetDiffuse(1, 1, 1);
light4.SetDirection(-0.409, -0.495, 2.238);
lights.push_back(light4);

LightModel light5(5, 20);
light5.lightIndex =16389;
light5.SetPosition(-0.032, 2.883, -0.076);
light5.SetAmbient(0.1, 0.1, 0.1);
light5.SetDiffuse(1, 1, 1);
light5.SetDirection(0.139, -0.495, -1.211);
lights.push_back(light5);

LightModel light6(6, 20);
light6.lightIndex =16390;
light6.SetPosition(0, 3.176, 0);
light6.SetAmbient(0.1, 0.1, 0.1);
...
CollisionBox37.Rotate(0, 14.89, 0);
...
CollisionBox38.Rotate(0, 14.89, 0);
...
CollisionBox43.Rotate(0, 14.89, 0);
...
CollisionBox44.Rotate(0, 14.89, 0);
...
CollisionBox45.SetAnimParam(0, 0, 0, 0, 0, 0.013, 0, 0, 0);
...
CollisionBox53.Rotate(0, 14.89, 90);
...
CollisionBox54.Rotate(0, 14.89, 90);
...
CollisionBox55.Rotate(0, 14.89, 0);
...
CollisionBox56.Rotate(0, 14.89, 0);
...
CollisionBox57.Rotate(0, 14.89, 0);
