...
//Backup at: 2020-11-19 at: 5:34:18

Object Character0("Character");
Character0.centralize = true;
Character0.SetCenter(-0.433333,0.7,0.676667);
Character0.SetGroupTranslate(0,0.7,0);
Character0.SetGroupRotate(0,-15.5,0);
...
Cube0.Translate(-0.52, 0.02, 0.65);
Cube0.Scale(0.55, 0.55, 0.55);
Cube0.Rotate(0, -15.5, 0);
...
Cylinder1.Translate(-0.4, 0, 0.6);
Cylinder1.Scale(1, 0.3, 1);
Cylinder1.Rotate(0, -15.5, 0);
...
CollisionBox3.Translate(-0.38, -0.02, 0.78);
CollisionBox3.Scale(2.32, 1.2, 1);
CollisionBox3.Rotate(0, -15.5, 0);
