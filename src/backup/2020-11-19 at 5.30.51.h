...
//Backup at: 2020-11-19 at: 5:30:51

Object 10("1");
10.centralize = true;
10.SetCenter(-0.06,0.01,0.025);
10.SetGroupTranslate(0,0,0);
10.SetGroupRotate(0,0,0);
