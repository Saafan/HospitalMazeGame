...
//Backup at: 2020-11-19 at: 4:50:15

Object Character0("Character");
Character0.centralize = true;
Character0.SetCenter(-7.05,4.135,-3.285);
Character0.SetGroupTranslate(-6.8,1.4,-1.6);
Character0.SetGroupRotate(-20,-260.4,-26.1);
