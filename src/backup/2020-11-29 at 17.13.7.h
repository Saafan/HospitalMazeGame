...
//Backup at: 2020-11-29 at: 17:13:7
...
Model3D0.Translate(1.49e-08, 0, 0.9);
...
CollisionBox1.Translate(0.13, 0.3, 0.9);
...
Model3D3.Translate(0, 0, 0);
models.emplace_back(Model3D3);

 // Model3D4
Model Model3D4;
Model3D4.Assign3DModel("models/walls/walls.3ds");
Model3D4.Translate(-4.14, 0, -5.01);
Model3D4.Scale(0.012, 0.006, 0.047);
