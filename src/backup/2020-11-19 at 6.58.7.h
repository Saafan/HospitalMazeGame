...
//Backup at: 2020-11-19 at: 6:58:7
...
CollisionBox2.Rotate(-65.5, 12, 0);
...
CollisionBox4.Translate(-0.14, 0, 0);
CollisionBox4.Scale(2.29, 1.63, 1.46);
CollisionBox4.Rotate(-65.5, 12, 0);
...
CollisionBox5.Translate(-0.14, 0, 0);
CollisionBox5.Scale(1.84, 1.63, 1.46);
CollisionBox5.Rotate(-65.5, 12, 0);
CollisionBox5.collider = true;
models.emplace_back(CollisionBox5);

 // CollisionBox6
Model CollisionBox6;
CollisionBox6.CreateWireCube(0.5);
CollisionBox6.Translate(-0.14, 0, 0);
CollisionBox6.Scale(1.84, 1.63, 1.46);
CollisionBox6.Rotate(-65.5, 12, 0);
CollisionBox6.collider = true;
models.emplace_back(CollisionBox6);
