...
//Backup at: 2020-11-19 at: 4:44:31

Object Character0("Character");
Character0.centralize = true;
Character0.SetCenter(-0.35,1.335,-2.485);
Character0.SetGroupTranslate(-0.1,-1.4,-0.8);
Character0.SetGroupRotate(15.3,-142.3,58.2);
...
Sphere2.Rotate(15.3, -142.3, 58.2);
