...
//Backup at: 2020-11-29 at: 21:54:46
...
Object walls7("walls");
walls7.SetCenter(0,0,0);
walls7.SetGroupTranslate(0,0,0);
walls7.SetGroupRotate(0,0,0);
objs.emplace_back(walls7);

 // Model3D0 of Group Character
Model Model3D0;
Model3D0.Assign3DModel("models/patient/patient.3ds");
Model3D0.Translate(-2, 0, 2.9);
...
CollisionBox1.Translate(-1.87, 0.3, 2.9);
