...
//Backup at: 2020-11-29 at: 18:4:4
...
models.emplace_back(Model3D7);
 ...
 // Model3D8
Model Model3D8;
Model3D8.Assign3DModel("models/walls/walls.3ds");
Model3D8.Translate(-2.98, -4.99, -1.63);
Model3D8.Scale(0.036, 0.062, 0.035);
Model3D8.Rotate(-90, 0, 0);
