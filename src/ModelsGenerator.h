...
Object ground5078("ground507");
ground5078.SetCenter(0,0,0);
ground5078.SetGroupTranslate(0,0,0);
ground5078.SetGroupRotate(0,0,0);
objs.emplace_back(ground5078);
...
Model3D5.Translate(0, -5.44, -2.87);
Model3D5.Scale(0.05, 0.05, 0.05);
Model3D5.Rotate(0, 90, 90);
Model3D5.group = 5;
...
Model3D6.Translate(-4.83, -1.79, 3.23);
Model3D6.Scale(0.101, 0.101, 0.101);
...
Model3D7.Translate(2.76, 3.42, -0.58);
...
Model3D10.Translate(-2.74, -1.77, -9.11);
Model3D10.Scale(0.02, 0.02, 0.02);
...
Model3D12.Translate(3.38, -1.35, 8.34);
...
Model3D13.Translate(1.54, -1.27, -11.61);
Model3D13.Scale(0.015, 0.015, 0.015);
...
Model3D18.Translate(-10.21, -0.68, -0.15);
...
Model3D31.Translate(6.11, 0.27, 0.87);
Model3D31.Scale(0.07, 0.07, 0.07);
Model3D31.Rotate(0, 90, 6);
models.emplace_back(Model3D31);

 // Model3D32
Model Model3D32;
Model3D32.Assign3DModel("models/tableu/tableu.3ds");
Model3D32.Translate(4.71, 6.06, 6.17);
Model3D32.Scale(0.211, 0.211, 0.211);
Model3D32.Rotate(90.5, 0, -88.5);
models.emplace_back(Model3D32);

 // Model3D33
Model Model3D33;
Model3D33.Assign3DModel("models/hidden/hidden.3ds");
Model3D33.Translate(0.01, 0, 0);
Model3D33.Scale(1.377, 1.377, 1.377);
models.emplace_back(Model3D33);

 // Cube34
Model Cube34;
Cube34.CreateCube(0.5);
Cube34.Translate(0.55, 0.34, -2.54);
Cube34.Scale(3.279, 6.867, 0.022);
Cube34.SetColor(0.03922, 0.01038, 0.01038);
models.emplace_back(Cube34);

 // Model3D35 of Group ground
Model Model3D35;
Model3D35.Assign3DModel("models/floor/floor.3ds");
Model3D35.Translate(-5.56, -1.5, 0);
Model3D35.Scale(0.06, 0.1, 0.03);
Model3D35.group = 4;
models.emplace_back(Model3D35);

 // Model3D36 of Group ground
Model Model3D36;
Model3D36.Assign3DModel("models/floor/floor.3ds");
Model3D36.Translate(-5.47, -1.59, -8.83);
Model3D36.Scale(0.06, 0.1, 0.03);
Model3D36.group = 4;
models.emplace_back(Model3D36);

 // Model3D37 of Group Group43
Model Model3D37;
Model3D37.Assign3DModel("models/walls/walls.3ds");
Model3D37.Translate(-2.61, 11.4, -1.76);
Model3D37.Scale(0.037, 0.062, 0.035);
Model3D37.Rotate(-90, 0, 0);
Model3D37.group = 7;
models.emplace_back(Model3D37);

 // Model3D38 of Group Group43
Model Model3D38;
Model3D38.Assign3DModel("models/walls/walls.3ds");
Model3D38.Translate(-10.43, -3.81, -1.72);
Model3D38.Scale(0.037, 0.042, 0.034);
Model3D38.Rotate(-90, 0, -90);
Model3D38.group = 7;
models.emplace_back(Model3D38);

 // Model3D39 of Group Group43
Model Model3D39;
Model3D39.Assign3DModel("models/walls/walls.3ds");
Model3D39.Translate(-10.59, 5.66, -1.57);
Model3D39.Scale(0.035, 0.015, 0.034);
Model3D39.Rotate(-90, 0, -90);
Model3D39.group = 7;
models.emplace_back(Model3D39);

 // Model3D40 of Group keys
Model Model3D40;
Model3D40.Assign3DModel("models/keys/keys.3ds");
Model3D40.Translate(0, -8.75, 3.18);
Model3D40.Scale(0.05, 0.05, 0.05);
Model3D40.Rotate(0, 90, 90);
Model3D40.group = 5;
models.emplace_back(Model3D40);

 // CollisionBox41 of Group Character
Model CollisionBox41;
CollisionBox41.CreateWireCube(0.5);
CollisionBox41.Translate(3.37, -0.06, 7.77);
CollisionBox41.Scale(1.422, 4.614, 1);
CollisionBox41.collider = true;
CollisionBox41.group = 0;
models.emplace_back(CollisionBox41);

 // CollisionBox42
Model CollisionBox42;
CollisionBox42.CreateWireCube(0.5);
CollisionBox42.Translate(3.28, -0.05, 8.18);
CollisionBox42.Scale(1.973, 1.973, 1.973);
CollisionBox42.collider = true;
CollisionBox42.animated = true;
CollisionBox42.SetAnimParam(3.28, -0.05, 8.18, 0, 0, 0, 1.973, 1.973, 1.973);
CollisionBox42.soundFileName = "lose.wav";
CollisionBox42.animSoundFileName = "lose.wav";
