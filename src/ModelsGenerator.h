...
light6.SetDiffuse(1, 1, 1);
light6.SetDirection(-0.196, -1, 0);
light6.spotLight = false;
light6.SetAnimationColor(true, true, true);
light6.lightChangeSpeed =0.43;
light6.firstRoom =false;
lights.push_back(light6);

LightModel light7(7, 180);
light7.lightIndex =16391;
light7.lightIndex =16391;
light7.SetPosition(-0.288, 0.553, 0);
light7.SetDiffuse(0.784314, 0.784314, 0.784314);
light7.SetDirection(-0.266, -0.747, 0);
lights.push_back(light7);

LightModel light8(8, 180);
light8.lightIndex =16392;
light8.lightIndex =16392;
light8.SetPosition(0, 1.676, 0);
light8.SetDiffuse(0.784314, 0.784314, 0.784314);
light8.SetDirection(-1.068, -0.336, -2.167);
...
Model3D33.Translate(7.92, 0, -0.91);
...
CollisionBox34.Translate(7.92, 0.55, -0.91);
CollisionBox34.Scale(0.228, 1.758, 0.634);
...
CollisionBox38.Rotate(0, 5975, 0);
...
CollisionBox39.Rotate(0, 5975, 0);
...
CollisionBox44.Rotate(0, 5975, 0);
...
CollisionBox45.Rotate(0, 5975, 0);
...
CollisionBox54.Rotate(0, 5975, 90);
...
CollisionBox55.Rotate(0, 5975, 90);
...
CollisionBox56.Rotate(0, 5975, 0);
...
CollisionBox57.Rotate(0, 5975, 0);
...
CollisionBox58.Rotate(0, 5975, 0);
...
CollisionBox69.Translate(2.34, 0.76, 0.05);
CollisionBox69.Scale(0.331, 3.101, 1);
