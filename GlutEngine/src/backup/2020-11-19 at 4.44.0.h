...
//Backup at: 2020-11-19 at: 4:44:0

Object Character0("Character");
Character0.centralize = true;
Character0.SetCenter(-0.65,1.435,-4.785);
Character0.SetGroupTranslate(-0.4,-1.3,-3.1);
Character0.SetGroupRotate(11.7,-150.5,58.2);
...
Sphere2.Rotate(11.7, -150.5, 58.2);
