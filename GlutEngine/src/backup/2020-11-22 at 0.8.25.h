...
//Backup at: 2020-11-22 at: 0:8:25
...
Sphere1.Translate(-1.18, 0.49, -0.2);
...
CollisionBox2.Translate(-1.16, 0.17, -0.18);
...
Cube5.Translate(0, 1.51, 0);
Cube5.Scale(0.11, 3, 0.11);
models.emplace_back(Cube5);

 // Cube6
Model Cube6;
Cube6.CreateCube(0.5);
Cube6.Translate(0, 1.51, 0);
Cube6.Scale(0.11, 3, 0.11);
