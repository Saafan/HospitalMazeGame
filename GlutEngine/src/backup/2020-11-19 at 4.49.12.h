...
//Backup at: 2020-11-19 at: 4:49:12

Object Character0("Character");
Character0.centralize = true;
Character0.SetCenter(-0.35,1.335,-2.485);
Character0.SetGroupTranslate(-5.5,0.7,-0.8);
Character0.SetGroupRotate(-119.5,-138.8,-26.1);
...
Sphere2.Rotate(-119.5, -138.8, -26.1);
