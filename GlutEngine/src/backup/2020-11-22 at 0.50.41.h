...
//Backup at: 2020-11-22 at: 0:50:41
...
Cube0.Translate(-2.384e-06, 0, 0.24);
...
Sphere1.Translate(0.03, 0.49, 0.24);
...
CollisionBox2.Translate(0.05, 0.17, 0.26);
...
CollisionBox3.Translate(-2.4, -0.02, 0.44);
