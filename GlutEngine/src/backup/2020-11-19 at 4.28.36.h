...
//Backup at: 2020-11-19 at: 4:28:36

Object Character0("Character");
Character0.centralize = false;
Character0.SetCenter(0,0,0);
Character0.SetGroupTranslate(0.9,-5.6,-3.1);
Character0.SetGroupRotate(-191.5,-143.5,-21.1);
...
Sphere2.Rotate(-191.5, -143.5, -21.1);
